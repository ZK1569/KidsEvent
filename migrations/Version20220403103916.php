 ...
 */
final class Version20220403103916 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE supplement (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, price INT NOT NULL, slug VARCHAR(255) NOT NULL, main_picture VARCHAR(255) NOT NULL, short_description LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE purchase CHANGE purchased_at purchased_at DATETIME NOT NULL, CHANGE reserve_for reserve_for DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE purchase CHANGE purchased_at purchased_at DATETIME DEFAULT NULL, CHANGE reserve_for reserve_for DATETIME DEFAULT NULL');
    }
}
